...
/// @title IHToken
/// @author Hifi
/// @notice Interface for the HToken contract
    ...
    IErc20Recover /// one dependency
{
    ...
    /// @notice Increases the debt of the caller and mints new hToken.
    ///
    ...
    /// - The total supply of hTokens cannot exceed the debt ceiling.
    ...
    /// @notice Deletes the borrower account's debt from the registry and take the hTokens
    /// out of circulation.
    ///
    ...
    /// @notice Clears the borrower account's debt from the registry and take the hTokens
    /// out of circulation.
    ///
    /// @dev Emits a {Burn}, {Transfer} and {RepayBorrow} event.
    ///
    ...
    /// least `repayAmount` hTokens to repay the borrow.
    ///
    ...
    /// @notice The Erc20 collateral associated with this HToken.
    ...
    /// @notice The unique Fintroller associated with this HToken.
    function fintroller() external view returns (IFintroller);

    /// @notice The unique RedemptionPool associated with this HToken.
