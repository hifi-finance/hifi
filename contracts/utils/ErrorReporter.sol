...
abstract contract ErrorReporter {
    ...
    enum AdminError { ERR_NOT_ADMIN, ERR_SET_ADMIN_ZERO_ADDRESS }
    ...
    enum OrchestratableError { ERR_NOT_CONDUCTOR, ERR_NOT_ORCHESTRATED, ERR_SET_CONDUCTOR_ZERO_ADDRESS }
