...
export function getFyTokenName(expirationTime: BigNumber, prefix: string = "Hifi USDC"): string {
...
export function getFyTokenSymbol(expirationTime: BigNumber, prefix: string = "hUSDC"): string {
  const expirationDate: Date = new Date(expirationTime.toNumber() * 1000);
