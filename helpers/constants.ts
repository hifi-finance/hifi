...
export const CUTOFF_TTM: BigNumber = fp("119836799");
...
export const SECONDS_YEAR: BigNumber = secondsInYears(1).mul(SCALE);
export const SECONDS_FOUR_YEARS: BigNumber = secondsInYears(4).mul(SCALE);
