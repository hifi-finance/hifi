...
export interface GodModeHifiPoolInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "PERMIT_TYPEHASH"
  ...
  encodeFunctionData(
    functionFragment: "__godMode_setTotalSupply",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "__godMode_toInt256",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface GodModeHifiPool extends BaseContract {
  connect(runner?: ContractRunner | null): GodModeHifiPool;
  ...
  __godMode_setTotalSupply: TypedContractMethod<
  ...
  __godMode_setUnderlyingPrecisionScalar: TypedContractMethod<
    [underlyingPrecisionScalar_: BigNumberish],
    [void],
    "nonpayable"
  >;

  __godMode_toInt256: TypedContractMethod<[x: BigNumberish], [bigint], "view">;
  ...
  getFunction(
    nameOrSignature: "__godMode_setTotalSupply"
  ...
  >;
  getFunction(
    nameOrSignature: "__godMode_toInt256"
