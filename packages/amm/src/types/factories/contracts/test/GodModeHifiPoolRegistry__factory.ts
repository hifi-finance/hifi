...
export class GodModeHifiPoolRegistry__factory extends ContractFactory {
  ...
  ): GodModeHifiPoolRegistry__factory {
    return super.connect(runner) as GodModeHifiPoolRegistry__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): GodModeHifiPoolRegistryInterface {
    return new Interface(_abi) as GodModeHifiPoolRegistryInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as GodModeHifiPoolRegistry;
  }
}
