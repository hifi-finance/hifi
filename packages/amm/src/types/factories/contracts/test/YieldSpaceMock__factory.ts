...
export class YieldSpaceMock__factory extends ContractFactory {
  ...
  ): Promise<YieldSpaceMock> {
    return super.deploy(overrides || {}) as Promise<YieldSpaceMock>;
  }
  ...
  override attach(address: string): YieldSpaceMock {
    return super.attach(address) as YieldSpaceMock;
  }
  override connect(signer: Signer): YieldSpaceMock__factory {
    return super.connect(signer) as YieldSpaceMock__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): YieldSpaceMockInterface {
    return new utils.Interface(_abi) as YieldSpaceMockInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): YieldSpaceMock {
    return new Contract(address, _abi, signerOrProvider) as YieldSpaceMock;
  }
}
