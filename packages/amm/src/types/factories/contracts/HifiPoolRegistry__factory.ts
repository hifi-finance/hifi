...
export class HifiPoolRegistry__factory extends ContractFactory {
  ...
  override connect(runner: ContractRunner | null): HifiPoolRegistry__factory {
    return super.connect(runner) as HifiPoolRegistry__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): HifiPoolRegistryInterface {
    return new Interface(_abi) as HifiPoolRegistryInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): HifiPoolRegistry {
    return new Contract(address, _abi, runner) as unknown as HifiPoolRegistry;
  }
}
