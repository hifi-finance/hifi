...
export const TASK_DEPLOY_CONTRACT_COLLATERAL_FLASH_UNISWAP_V2: string = "deploy:contract:collateral-flash-uniswap-v2";
export const TASK_DEPLOY_CONTRACT_UNDERLYING_FLASH_UNISWAP_V2: string = "deploy:contract:underlying-flash-uniswap-v2";
