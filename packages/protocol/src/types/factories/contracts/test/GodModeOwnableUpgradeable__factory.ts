...
export class GodModeOwnableUpgradeable__factory extends ContractFactory {
  ...
  ): Promise<GodModeOwnableUpgradeable> {
    return super.deploy(overrides || {}) as Promise<GodModeOwnableUpgradeable>;
  }
  ...
  override attach(address: string): GodModeOwnableUpgradeable {
    return super.attach(address) as GodModeOwnableUpgradeable;
  }
  override connect(signer: Signer): GodModeOwnableUpgradeable__factory {
    return super.connect(signer) as GodModeOwnableUpgradeable__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): GodModeOwnableUpgradeableInterface {
    return new utils.Interface(_abi) as GodModeOwnableUpgradeableInterface;
  }
  static connect(
    address: string,
