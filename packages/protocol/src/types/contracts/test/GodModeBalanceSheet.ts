...
export interface GodModeBalanceSheetInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface GodModeBalanceSheet extends BaseContract {
  connect(runner?: ContractRunner | null): GodModeBalanceSheet;
  ...
  __godMode_setBondList: TypedContractMethod<
    [account: AddressLike, bondList: AddressLike[]],
    [void],
    "nonpayable"
  >;

  __godMode_setCollateralAmount: TypedContractMethod<
    [
      account: AddressLike,
      collateral: AddressLike,
  ...
  __godMode_setCollateralList: TypedContractMethod<
    [account: AddressLike, collateralList: AddressLike[]],
    [void],
    "nonpayable"
  >;

  __godMode_setDebtAmount: TypedContractMethod<
    [account: AddressLike, bond: AddressLike, newDebtAmount: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  initialize: TypedContractMethod<
    [fintroller_: AddressLike, oracle_: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "__godMode_setBondList"
  ): TypedContractMethod<
    [account: AddressLike, bondList: AddressLike[]],
    [void],
    "nonpayable"
  >;
  getFunction(
    nameOrSignature: "__godMode_setCollateralAmount"
  ): TypedContractMethod<
    [
      account: AddressLike,
      collateral: AddressLike,
  ...
  >;
  getFunction(
    nameOrSignature: "__godMode_setCollateralList"
  ): TypedContractMethod<
    [account: AddressLike, collateralList: AddressLike[]],
    [void],
    "nonpayable"
  >;
  getFunction(
    nameOrSignature: "__godMode_setDebtAmount"
  ): TypedContractMethod<
    [account: AddressLike, bond: AddressLike, newDebtAmount: BigNumberish],
    [void],
    "nonpayable"
