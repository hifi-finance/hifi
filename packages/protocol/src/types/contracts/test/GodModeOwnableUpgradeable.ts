...
export interface GodModeOwnableUpgradeableInterface extends utils.Interface {
  functions: {
    "__godMode_Ownable_init()": FunctionFragment;
...
export interface GodModeOwnableUpgradeable extends BaseContract {
  ...
  callStatic: {
    __godMode_Ownable_init(overrides?: CallOverrides): Promise<void>;
