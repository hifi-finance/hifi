...
export interface GodModeOwnableUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "__godMode_Ownable_init"
      | "_renounceOwnership"
      | "_transferOwnership"
      | "owner"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "__godMode_Ownable_init",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface GodModeOwnableUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): GodModeOwnableUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: GodModeOwnableUpgradeableInterface;
  ...
  __godMode_Ownable_init: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "__godMode_Ownable_init"
