...
export async function increaseUniswapV3PoolReserves(this: Mocha.Context, mintLiquidity: string): Promise<void> {
  ...
  await this.contracts.nonfungiblePositionManager
    ...
    .createAndInitializePoolIfNecessary(
      ...
      500,
      encodePriceSqrt("20000000000", "100000000"),
    );
  ...
  const position = new Position({
    pool: pool,
    liquidity: mintLiquidity, //"120000000000000",
