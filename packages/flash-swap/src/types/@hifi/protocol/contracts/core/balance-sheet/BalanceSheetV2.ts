...
export interface BalanceSheetV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "_renounceOwnership"
      | "_transferOwnership"
...
export interface BalanceSheetV2 extends BaseContract {
  connect(runner?: ContractRunner | null): BalanceSheetV2;
  waitForDeployment(): Promise<this>;

  interface: BalanceSheetV2Interface;
