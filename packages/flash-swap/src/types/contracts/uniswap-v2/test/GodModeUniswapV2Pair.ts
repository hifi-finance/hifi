...
export interface GodModeUniswapV2PairInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "MINIMUM_LIQUIDITY"
  ...
  encodeFunctionData(
    functionFragment: "__godMode_setToken0",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
    functionFragment: "__godMode_setToken1",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export interface GodModeUniswapV2Pair extends BaseContract {
  connect(runner?: ContractRunner | null): GodModeUniswapV2Pair;
  waitForDeployment(): Promise<this>;

  interface: GodModeUniswapV2PairInterface;
  ...
  __godMode_setToken0: TypedContractMethod<
    [newToken0: AddressLike],
    [void],
    "nonpayable"
  >;

  __godMode_setToken1: TypedContractMethod<
    [newToken1: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "__godMode_setToken0"
  ): TypedContractMethod<[newToken0: AddressLike], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "__godMode_setToken1"
  ): TypedContractMethod<[newToken1: AddressLike], [void], "nonpayable">;
  getFunction(
