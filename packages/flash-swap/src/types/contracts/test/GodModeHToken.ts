...
export interface GodModeHToken extends BaseContract {
  ...
  __godMode_setUnderlying: TypedContractMethod<
    [newUnderlying: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "__godMode_setUnderlying"
  ): TypedContractMethod<[newUnderlying: AddressLike], [void], "nonpayable">;
  getFunction(
