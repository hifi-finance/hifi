...
export interface GodModeUniswapV3FactoryInterface extends utils.Interface {
  functions: {
...
export interface GodModeUniswapV3Factory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GodModeUniswapV3FactoryInterface;
