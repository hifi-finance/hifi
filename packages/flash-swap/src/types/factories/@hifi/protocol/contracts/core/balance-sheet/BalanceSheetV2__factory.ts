...
import type {
  BalanceSheetV2,
  BalanceSheetV2Interface,
} from "../../../../../../@hifi/protocol/contracts/core/balance-sheet/BalanceSheetV2";
...
type BalanceSheetV2ConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: BalanceSheetV2ConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class BalanceSheetV2__factory extends ContractFactory {
  constructor(...args: BalanceSheetV2ConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override connect(runner: ContractRunner | null): BalanceSheetV2__factory {
    return super.connect(runner) as BalanceSheetV2__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): BalanceSheetV2Interface {
    return new Interface(_abi) as BalanceSheetV2Interface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): BalanceSheetV2 {
    return new Contract(address, _abi, runner) as unknown as BalanceSheetV2;
  }
}
