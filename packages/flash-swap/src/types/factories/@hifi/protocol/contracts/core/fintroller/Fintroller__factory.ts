...
import type {
  Fintroller,
  FintrollerInterface,
} from "../../../../../../@hifi/protocol/contracts/core/fintroller/Fintroller";
...
export class Fintroller__factory extends ContractFactory {
  ...
  override connect(runner: ContractRunner | null): Fintroller__factory {
    return super.connect(runner) as Fintroller__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): FintrollerInterface {
    return new Interface(_abi) as FintrollerInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): Fintroller {
    return new Contract(address, _abi, runner) as unknown as Fintroller;
  }
}
