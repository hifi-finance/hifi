...
export class MaliciousPair__factory extends ContractFactory {
  ...
  override deploy(
    ...
    return super.deploy(collateral_, underlying_, overrides || {}) as Promise<
      MaliciousPair & {
        deploymentTransaction(): ContractTransactionResponse;
      }
    >;
  }
  override connect(runner: ContractRunner | null): MaliciousPair__factory {
    return super.connect(runner) as MaliciousPair__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): MaliciousPairInterface {
    return new Interface(_abi) as MaliciousPairInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): MaliciousPair {
    return new Contract(address, _abi, runner) as unknown as MaliciousPair;
  }
}
