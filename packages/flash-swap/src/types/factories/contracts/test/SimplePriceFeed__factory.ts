...
export class SimplePriceFeed__factory extends ContractFactory {
  ...
  override deploy(
    ...
    return super.deploy(description_, overrides || {}) as Promise<
      SimplePriceFeed & {
        deploymentTransaction(): ContractTransactionResponse;
      }
    >;
  }
  override connect(runner: ContractRunner | null): SimplePriceFeed__factory {
    return super.connect(runner) as SimplePriceFeed__factory;
  }
  ...
  static connect(
    ...
    return new Contract(address, _abi, runner) as unknown as SimplePriceFeed;
  }
}
