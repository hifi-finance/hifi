      ...
      describe("when the value of the collateralization ratio is not valid", function () {
        describe("when the collateralization ratio is higher than 10,000%", function () {
          it("reverts", async function () {
            ...
            await expect(
              this.fintroller.setCollateralizationRatio(this.yToken.address, overflowCollateralizationRatioMantissa),
        ...
        describe("when the collateralization ratio is lower than 100%", function () {
          it("reverts", async function () {
            ...
            await expect(
              this.fintroller.setCollateralizationRatio(this.yToken.address, underflowCollateralizationRatioMantissa),
        ...
        describe("when the collateralization ratio is zero", function () {
          it("reverts", async function () {
            await expect(this.fintroller.setCollateralizationRatio(this.yToken.address, Zero)).to.be.revertedWith(
